...
public:
    ...
    vector<Document> FindTopDocuments(const string& raw_query, DocumentStatus status_find) const{
        auto filter_default = [status_find](int document_id, DocumentStatus status, int rating) {
            return status == status_find; };
        
        return FindTopDocuments(raw_query, filter_default);    
    }
